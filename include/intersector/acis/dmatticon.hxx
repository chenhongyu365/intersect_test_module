...
/*******************************************************************/
#ifndef DM_ATT_ICON_H
#define DM_ATT_ICON_H
//
// Header for the DM_att_icon class.
//
// Purpose: The DM_att_icon class is used for drawing point attractor tag
// objects in deformable modeling.
//
// Description: The DM_att_icon is part of the dmicon library. This
// icon updates a marker to depict the current SPAposition of an attractor.
//
 ...
 * <br>
 * <b>Role:</b> The <tt>DM_att_icon</tt> is part of the <tt>dmicon</tt> library. This icon updates a marker
 * to depict the current position of an attractor.
 * <br><br>
 * <b>Related classes</b>
 * <br>
...
class DECL_DM_ICON DM_att_icon : public DM_default_icon { // atti
...
//
 ...
 protected:
    ...
    */
   DM_att_icon(const DM_att_icon&) ;// should not call copy constructor
                                    // call Make_copy & Set_owner

   virtual ~DM_att_icon();          // should call Lose
 ...
 */
   ...
   DM_att_icon();                                   // public constructor
